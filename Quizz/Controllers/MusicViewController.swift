...
//            self.labelVerno.text = "Неверно!"
    ...
    func updateQustion() {
            if qustionNumber <= allQustion.list4.count - 1 {
                qustionLabel.text = allQustion.list4[qustionNumber].questionLabel
                optionA.setTitle(allQustion.list4[qustionNumber].optionA, for: .normal)
                optionB.setTitle(allQustion.list4[qustionNumber].optionB, for: .normal)
                optionC.setTitle(allQustion.list4[qustionNumber].optionC, for: .normal)
                optionG.setTitle(allQustion.list4[qustionNumber].optionG, for: .normal)
                selectAnswer = allQustion.list4[qustionNumber].correctAnswer
