...
class QustionBank{
    ...
    init (){
        ...
        cosmosList.append(Qustion(questionText: "Сколько длятся одни Земные сутки на Венере?", choiceA: "а) 245 дней", choiceB: "б) 1 час", choiceC: "в) 30 дней", choiceG: "г) 24 часа", answer: 1))
        //BOOK
        ...
        bookList.append(Qustion(questionText: "В каком произведении слышится предупреждение о том, что нарушение естественного хода вещей приводит к необратимым последствиям?", choiceA: "а) Роковые яйца", choiceB: "б) Собачье сердце", choiceC: "в) Мастер и Маргарита", choiceG: "г) Белая гвардия", answer: 2))
       ...
       geograhpyList.append(Qustion(questionText: "Какое море является самым холодным?", choiceA: "а) Красное море", choiceB: "б) Персидский залив", choiceC: "в) Черное море", choiceG: "г) Белое море", answer: 4))
        ...
        scienceList.append(Qustion(questionText: "В какое времмя сутки короче?", choiceA: "а) Осенью", choiceB: "б) Весной", choiceC: "в) Зимой", choiceG: "г) Всегда одинаковые", answer: 4))
